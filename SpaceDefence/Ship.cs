    ...
    public class Ship : GameObject
    {
        ...
        public override void Load(ContentManager content)
        {
            ...
            drawRectangle = new Rectangle(
                _rectangleCollider.shape.Center,
                ship_body.Bounds.Size
            );
        ...
        {
            spriteBatch.Draw(ship_body, drawRectangle, null, Color.White, angle, ship_body.Bounds.Size.ToVector2() / 2f, SpriteEffects.None, 0);
